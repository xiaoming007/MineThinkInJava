...
" 将选中的代码生成方法
    nnoremap <Leader>nm :action ExtractMethod<CR>
" 新建文件夹
...
"清理不用的import
    ...
    nnoremap <Leader>sn :action Android.SyncProject<CR>
    nnoremap <Leader>hn :action HideActiveWindow<CR>
...
"version check
    ...
    nnoremap <Leader>va :action Git.Commit.And.Push.Executor<CR>
